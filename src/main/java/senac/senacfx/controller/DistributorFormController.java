...
public class DistributorFormController implements Initializable {
    ...
    @FXML
    private ComboBox<Factory> comboBoxDepartment;
    @FXML
    ...
    public void setSeller(Distributor entity){
        this.entity = entity;
    }

    public void setServices(DistributorService service, FactoryService factoryService){
    ...
    private Distributor getFormData() {
    ...
    private void initializeComboBoxDepartment() {
        Callback<ListView<Factory>, ListCell<Factory>> factory = lv -> new ListCell<Factory>() {
            @Override
            protected void updateItem(Factory item, boolean empty) {
